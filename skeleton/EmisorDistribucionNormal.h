...
public:
	...
	{
		Vector3 vel = Vector3(distribucionNormal(4, desviacion), distribucionNormal(4, desviacion), distribucionNormal(4, desviacion));
		...
		setModel({ posaux, vel, ac, tiempo, masa, PUNTO, {1,1,1,1} });
	};
